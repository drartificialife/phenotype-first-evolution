...
% For a list of packages that should be natively supported in Editorial
% Manager, see https://www.tug.org/texlive/Contents/live/doc.html 
% If you are using a different package, please upload any requisite
% style files.
...
% Authorship
%%%%%%%%%%%%%%%%%%%%%
% Please comment out authorship information while your paper is under review. 
% You will need to add this information back in to your final files after
% acceptance.
% If you find it more convenient, you can also upload your authorship
% information, acknowledgements, statement of authorship, etc., as a
% separate file in Editorial Manager with the item type "Title page".
...
\textit{Manuscript type}: Article. %Or note, natural history miscellany note, comment, reply, invited symposium, featured topic, historical perspective, or inspiring perspective.
...
This paragraph comes under a first-order heading. The quick red fox jumps over the lazy brown dog. Furthermore, the quick brown fox jumps over the lazy red dog. In addition, the quick R\"{u}ppell's fox (\textit{Vulpes rueppellii}) jumps over the lazy golden retriever.

\section*{Methods}

This paragraph likewise follows a first-order heading. Lorem ipsum ut velit mauris, egestas sed, gravida nec, ornare ut, mi. Aenean ut orci vel massa suscipit pulvinar. Nulla sollicitudin. Fusce varius, ligula non tempus aliquam, nunc turpis ullamcorper nibh, in tempus sapien eros vitae ligula (\citealt{OriginSpec}). 

\subsection*{Second-order heading}

Second-order headings are italicized. Lorem ipsum nulla facilisi, pace \citet{LemKapEx07}. Etiam semper, orci sit amet facilisis interdum, tellus nunc consequat erat, quis viverra nisi diam ut metus. Pellentesque cursus, sapien malesuada euismod iaculis, mauris purus interdum diam, vel vestibulum justo enim vitae tellus. Nunc interdum lorem sit amet diam volutpat tristique. Quisque pulvinar ac metus commodo lacinia (\citealt{Ing11,Xiao2015}).  
...
If you have deposited data to Dryad or a similar repository, it is advisable to cite them somewhere in the main text (usually in the Methods or Results sections). A sentence like the following will do: All data are available in the Dryad Digital Repository (\citealt{CookEtAl2015}).
...
OEC would like to thank Madlen Wilmes, Gyuri Barab\'{a}s, Flo D\'{e}barre, Vlastimil K\v{r}ivan, and Greg Dwyer for their comments and suggestions on this template. We are grateful to Mariana García Criado for using alt text on Bluesky (see \url{https://bsky.app/profile/nanitundra.bsky.social/post/3lo23jxxj4c2v} for an excellent thread), two examples of which are shown below.

%%%%%%%%%%%%%%%%%%%%%
% Statement of Authorship
%%%%%%%%%%%%%%%%%%%%%
% This section should also be commented out while your MS is undergoing
% double anonymous review. The specifics should of course be adapted to
...
Lorem ipsum dolor sit amet, as we have seen in figures~\ref{Fig:Jumps} and \ref{Fig:JumpsOk}. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet, ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.
...
\newblock American Naturalist, Dryad Digital Repository, \url{https://dx.doi.org/10.5061/dryad.XYZAB123}.
...
% As a new accessibility feature, all figure legends should be followed 
% by one or two sentences of alt text. This is read by screen readers
% and also displays in the HTML version when hovering the mouse.
% Alt text should not duplicate information in the legend or main text.
% Instead, succinctly describe what a reader would be missing if they 
% can't see the image.
...
\textbf{Alt text:} Figure with six subplots showing that species turnover was associated with temperature and temperature change, and that species gains and losses were greater at colder sites and at sites that warmed most. Losses were greater where shrub cover had increased most.}
\label{Fig:OkapiHorn}
\end{figure}
...
\caption{In this way, figure legends can be listed at the end of the document, with references that work. The includegraphics command should be commented out after acceptance and figure files uploaded separately to Editorial Manager. Editorial Manager should then insert them at the end of the PDF automatically. Graphics should be included during peer review. \\
\textbf{Alt text:} Figure with six subplots showing that overall plant net richness change was not different from zero. Species richness increased with increasing forb cover and decreased with increased erect shrub cover.}
...
\textbf{Alt text:} Two seventeenth-century oil paintings depicting foxes in motion in the vicinity of dogs sleeping in a forested landscape.}
\label{Fig:Jumps}
\end{figure}
...
\textbf{Alt text:} Graph displaying the correlation of increased jump speed with decreased distance from an okapi.}
\label{Fig:JumpsOk}
\end{figure}
...
\textbf{Alt text:} Twenty-second video showing a \LaTeX{} user typing a video legend on screen.}
\label{VideoExample}
\end{figure}
